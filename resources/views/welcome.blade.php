...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <title>Training and Placement Cell(IKGPTU Amritsar)</title>
  ...
  <link href="assets/css/style.css" rel="stylesheet">
    ...
    <header id="header" class="fixed-top">
      <div class="conn" style="margin-bottom:-30px;">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a href="contact">
            ...
            <li class="dropdown">
              ...
              <ul>
                ...
                <div class="relative">
                    ...
                    <div class="hidden">
                        @auth
                            <a href="{{ url('/home') }}" style="color:black;" class="text-sm text-gray-700 dark:text-gray-500 underline">Home</a>
                        @else
                            <a href="{{ route('login') }}" style="color:black;" class="text-sm text-gray-700 dark:text-gray-500 underline">Log in</a>
            ...
            <li class="dropdown" style="margin-right:100px;width:50px;">
              <span class="get-startedd-btn">For Admin <i class="bi bi-chevron-down"></i></span>
              <ul>
                <li><a href="admin/login" style="color:black;">Login</a></li>
              </ul>
            </li>
          </li>
        </ul>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="course-item">
              ...
              <div class="course-content">
                ...
                <p>BTech Computer Science, is a full-time engineering undergraduate degree programme in computer science that is concerned with the design, construction, and operation of computer hardware and software.</p>
                <div class="trainer d-flex justify-content-between align-items-center">
                  <div class="trainer-profile d-flex align-items-center">
