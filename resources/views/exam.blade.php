...
<head>
  ...
  <title>Placement Syllabus</title>
...
<div class="back" style="height:530px;">
...
<form action="exam" method="POST" class="row g-3" style="width:60%;background-color:#d9d9d9;border-radius:50px;float:right;margin-top:60px;margin-right:80px;">
@csrf
<h2 style="text-align:center;padding-top:20px;">Placement Syllabus</h2>
<div class="row mb-3" style="padding-top:40px;padding-left:40px;">
    <label for="inputEmail3" class="col-sm-3 col-form-label">Company Name :</label>
    <div class="col-sm-9">
      <input type="text" placeholder="Enter name of Company" class="form-control" id="cname" name="cname">
    </div>
  </div>
<div class="row mb-2" style="padding-top:5px;padding-left:40px;">
    ...
    <div class="col-sm-9" style="margin-left:60px;width:560px;">
    <textarea class="form-control" name="syllabus" placeholder="Add Syllabus" id="floatingTextarea2" style="height: 100px"></textarea>
    </div>
  </div>
  <div class="row mb-2" style="padding-top:5px;padding-left:40px;">
...
<input type="submit" class="btn btn-primary" value="Submit" onClick="Swal.fire({
  position: 'center',
  icon: 'success',
  title: 'New Syllabus has been added',
