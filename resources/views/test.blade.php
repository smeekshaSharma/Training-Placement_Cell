...
<form action="test" method="POST" class="row g-3" style="width:60%;background-color:#d9d9d9;border-radius:50px;float:right;margin-top:60px;margin-right:80px;">
@csrf
<h2 style="text-align:center;padding-top:20px;">Mock Test</h2>
<div class="row mb-3" style="padding-top:40px;padding-left:60px;">
    ...
    <div class="col-sm-9">
      <input type="text" placeholder="Enter name of Company" name="cname" class="form-control" id="cname">
    </div>
  </div>
  <div class="row mb-2" style="padding-top:10px;padding-left:60px;">
    <label for="media" class="col-sm-3 col-form-label">Media :</label>
    <div class="col-sm-6" style="margin-left:0px;width:550px;">
...
<input type="submit" class="btn btn-primary" value="Submit" onClick="Swal.fire({
  position: 'center',
  icon: 'success',
  title: 'Mock test has been added',
