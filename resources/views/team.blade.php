                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="no">{{$row['sname']}}</td>
                                <td class="no">{{$row['designation']}}</td>
                                <td class="no">{{$row['branch']}}</td>
                                <td class="no">{{$row['course']}}</td>
                                <td class="no">{{$row['year']}}</td>
