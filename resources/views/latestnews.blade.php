      ...
      <ul style="height:20px;">
        ...
        <li class="dropdown"><a href="#">
          ...
          <li><a href="cell" style="color:black;">Training & Placement</a></li>
            ...
            <li><a class="active" href="/" style="color:#cc0000;">Job Alerts</a></li>
...
<div class="container" style="margin-top:100px;">
  ...
  <div class='display6' style="margin-bottom:20px;"> Indeed job listings</div>
    @if(isset($err) == 1)
    <p class='alert-danger text-center py-4 w-40'>Check your internet speed or Try Refreshing</p>
    @endif
    @unless(empty($combine))
          <div>
            @foreach($combine as $key => $value)   
            <div class="card mx-3 my-1" style="width:65em;border-radius:50px;">
                <div class="card-body">
                <h5 class="card-title" style="color:#cc0000">{{$key}}</h5>
                <p class="card-text text-wrap" style=" white-space: pre;color:#000080; ">{{$value}}</p>
                </div>
            </div>
            @endforeach
          </div>
